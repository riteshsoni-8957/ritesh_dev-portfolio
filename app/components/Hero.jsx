...
function Hero() {
  return (
    <div className='bg-[#00020f] w-full px-4 py-[40px] min-[671px]:py-[80px] xl:py-[50px] flex flex-col min-[671px]:flex-row gap-9 min-[371px]:px-8'>
        {/* Hero Details */}
        <div className='w-full flex flex-col justify-center gap-3'>  
            ...
            {/* Building Modern ..... */}
            <h1 className='leading-none text-[26px] min-[471px]:text-[30px] min-[671px]:text-[26px] min-[871px]:text-[30px] lg:text-[35px] xl:text-[40px] text-cyan-50 font-[600]'>
                Building <br /> 
            ...
            <div className='flex gap-4'>
                <p className='text-[13px] min-[871px]:text-[15px] lg:text-[18px] xl:text-[21px] border-1 border-cyan-100 rounded-[5px] px-4 py-1 bg-gradient-to-r from-purple-600 to-fuchsia-500 hover:bg-gradient-to-r hover:from-purple-700 hover:to-fuchsia-600'>
                    Explore Work
                </p>

                <p className='text-[13px] min-[871px]:text-[15px] lg:text-[18px] xl:text-[21px] border-1 border-cyan-100 rounded-[5px] px-4 py-1 hover:bg-gray-700 '>
                    Download CV
                </p>
            </div>
            ...
            <div className="flex gap-4 mt-2">
                <Link href="https://github.com/riteshsoni-8957" target="_blank" className="text-[13px] border border-cyan-50 rounded-full p-2 hover:bg-fuchsia-400 hover:text-black hover:scale-[1.2]">
                    <FaGithub />
                </Link>

                <Link href="https://www.linkedin.com/in/ritesh-soni-4939a0270/" target="_blank" className="text-[13px] border border-cyan-50 rounded-full p-2 hover:bg-fuchsia-400 hover:text-black hover:scale-[1.2]">
                    <FaLinkedinIn />
                </Link>

                <Link href="mailto:riteshsoni35468@gmail.com" className="text-[13px] border border-cyan-50 rounded-full p-2 hover:bg-fuchsia-400 hover:text-black hover:scale-[1.2]">
                    <MdEmail />
                </Link>
            </div>
        </div>
        ...
        <div className='flex flex-col w-full h-full object-cover'>
            ...
            <div className="flex justify-between border rounded-[10px] px-[10px] xl:px-[20px] py-[5px] bg-gray-300/5">
